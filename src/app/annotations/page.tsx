...
import { ChevronRight, ChevronLeft, MessageSquare, CheckCircle, MessageCircle } from 'lucide-react';
...
export default function AnnotationsPage() {
  ...
  useEffect(() => {
    if (selectedAnnotation && editorRef.current) {
  ...
  }, [selectedAnnotation, annotations, panelOpen]);
